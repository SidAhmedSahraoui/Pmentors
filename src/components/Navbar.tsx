              ...
              <Popover className="relative">
                {({ open }) => (
                  <>
                    ...
                    >
                      <Popover.Panel className="absolute w-96 h-fit left-1/2 z-10 mt-3 -translate-x-1/2 transform px-4 sm:px-0">
                        <div className="overflow-hidden h-full rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                          <div className="relative h-full flex-col justify-evenly items-center content-center backdrop-blur-sm bg-gray-one p-7">
                            {services.map((item) => (
                              ...
                              >
                                <div className="flex h-10 w-10 shrink-0 items-center justify-center text-white bg-purple-one bg-gradient-to-r from-purple-two to-blue-one rounded-md sm:h-12 sm:w-12">
                                  <FontAwesomeIcon
                ...
                {({ open }) => (
                  <>
                    ...
                    <Transition
                      ...
                      leaveTo="opacity-0 translate-y-1"
                    >
                      <Popover.Panel className="absolute w-96 h-fit left-1/2 mt-3 -translate-x-1/2 transform px-4 sm:px-0">
                        <div className="overflow-hidden h-full rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
